(function() {
  ...
  angular
    ...
    .directive("sdServiceOfferingsAuthz", ServiceOfferingsDirective);

  ServiceOfferingsDirective.$inject = [];

  function ServiceOfferingsDirective() {
    var directive = {
    ...
    function link(scope, element, attrs) {
      console.log("ServiceOfferingsDirective", scope);
    }
  }
